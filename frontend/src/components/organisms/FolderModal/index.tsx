...
import { BACK, SYNC, ZEM_DECKS } from '@src/utils/constants';
type FilesDataType = {
  fileName: string;
  id: string;
  isChecked: boolean;
            ...
            <ModalHeader sx={{ marginBottom: '4.38vw' }}>
              <Stack direction="row" gap="1.53vw">
                <Icon
                  src={ChevronLeftIcon}
                  alt="chevron-left"
                  onClick={() => handleZemDecksBackClick()}
                />
                <Typography variant="h3">{ZEM_DECKS}</Typography>
              </Stack>
